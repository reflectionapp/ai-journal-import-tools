# Bear to Reflection: Migrate to an AI Journal

Move your Bear journal into Reflection, the AI journal, using exports and a simple conversion workflow.

## Overview

If you're switching from Bear, you don't need to start fresh. This guide shows how to export your entries, convert them to Reflection's CSV format, and import into Reflection so your journal history comes with you.

## What You'll Need

- A Bear export file (CSV, JSON, or text)
...
1. Open Bear and go to **Settings**
2. Select **Export**
3. Choose format: **Markdown** (recommended) or **PDF**
4. Choose export destination: your local folder
