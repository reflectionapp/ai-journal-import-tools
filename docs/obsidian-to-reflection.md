# Obsidian to Reflection: Migrate to an AI Journal

Move your Obsidian journal into Reflection, the AI journal, using exports and a simple conversion workflow.

## Overview

If you're switching from Obsidian, you don't need to start fresh. This guide shows how to export your entries, convert them to Reflection's CSV format, and import into Reflection so your journal history comes with you.

## What You'll Need

- A Obsidian export file (CSV, JSON, or text)
...
1. Open Obsidian and click the **Vault Switcher** (folder icon)
2. Select **Export Your Notes**
3. Choose format: **Markdown** (recommended) or **CSV**
4. Choose export location: your local folder
