# Logseq to Reflection: Migrate to an AI Journal

Move your Logseq journal into Reflection, the AI journal, using exports and a simple conversion workflow.

## Overview

If you're switching from Logseq, you don't need to start fresh. This guide shows how to export your entries, convert them to Reflection's CSV format, and import into Reflection so your journal history comes with you.

## What You'll Need

- A Logseq export file (CSV, JSON, or text)
...
1. Open Logseq and go to the **app menu** (top left)
2. Select **Export**
3. Choose format: **Markdown** (recommended), **JSON**, or **HTML**
