# Evernote to Reflection: Migrate to an AI Journal

Move your Evernote journal into Reflection, the AI journal, using exports and a simple conversion workflow.

## Overview

If you're switching from Evernote, you don't need to start fresh. This guide shows how to export your entries, convert them to Reflection's CSV format, and import into Reflection so your journal history comes with you.

## What You'll Need

- A Evernote export file (CSV, JSON, or text)
...
1. Open Evernote and go to **Account** > **Download Your Notes**
2. Select the notebooks or tags you want to export
3. Choose format: **XML** (.enex, recommended) or **PDF**
4. Download the export file to your local folder
