# Penzu to Reflection: Migrate to an AI Journal

Move your Penzu journal into Reflection, the AI journal, using exports and a simple conversion workflow.

## Overview

If you're switching from Penzu, you don't need to start fresh. This guide shows how to export your entries, convert them to Reflection's CSV format, and import into Reflection so your journal history comes with you.

## What You'll Need

- A Penzu export file (CSV, JSON, or text)
- A local folder for your conversion files
- One of the following:
  - An AI prompt workflow (ChatGPT, Claude, Gemini, or Grok)
  - Manual CSV mapping

## Step 1: Export from Penzu

1. Log in to your Penzu account
2. Go to **Account** > **Export**
3. Choose format: **CSV** (recommended), **PDF**, or **XML**
