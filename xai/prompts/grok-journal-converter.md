# Grok (xAI) Journal Converter Prompt for Reflection

Use Grok to convert a journal export into the Reflection CSV format so you can import entries into the AI journal. Start small, validate the output, then scale up.
...
TBD - Grok prompt to be developed in Phase 2
